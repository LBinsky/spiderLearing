...
// 4,0,360256
//单次滑动轨迹
// console.log(enc_slide('e03e1e135cac44639cfab0c9bced2488', '4,0,360256'));  // params: token, 单次滑动轨迹
// slide_array, example：4,0,360256;4,0,360256;4,0,360256;4,0,360256;4,0,360256


function enc_data(token, slide_array, trace_length){
    traceData = [];
    slide_array = slide_array.split(';');
    for (i=0;i<slide_array.length;i++){
        f = enc_slide(token, slide_array[i]+'');
        // console.log(f);
        traceData.push(f);
    }
    n = simple(traceData,50);
    r = eypt(enc_slide(token, trace_length/310*100+""));
    // console.log(traceData);
    return JSON.stringify({
        d: eypt(n.join(":")),
        m: "",
        p: r,
        ext: eypt(enc_slide(token, 1 + "," + traceData.length))
    })
}
slide_array = '4,0,360256;4,0,360256;4,0,360256;4,0,360256;4,0,360256';
console.log(enc_data('e03e1e135cac44639cfab0c9bced2488',slide_array));
